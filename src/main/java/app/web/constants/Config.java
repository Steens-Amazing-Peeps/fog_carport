...
public interface Config
{
    ...
    public static interface Bom
    {
        ...
        //Bom Logic
        int MINIMUM_BATCH_SIZE = 12; //Will try to find a valid result among these x cheapest planks, if not, increases the search by 1 planks //Cannot be negative //0 to search through all planks (can be slow)
